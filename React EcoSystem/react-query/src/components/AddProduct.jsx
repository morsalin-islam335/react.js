...
const AddProduct = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data, variables, context) => {
      // data: mutation howar por ja data asba, variable: data er jonno jasbo variable use hoba,  context:  mutation howar aga call hoba
      console.log(context);
      queryClient.invalidateQueries(["products"]);
    },
    onMutate: (variables) => {
      // eta mutation howar aga  call hoba, variable receive korta parba,  eta jeta return korba seta mutation a context hisaba use kora jaba.
